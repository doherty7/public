...
$(document).ready(function () {
    SHEET_MODIFY = function (gridId, op) {
        ...
        this.defaultHeight = op.defaultHeight;
...
//            }).join("&");
        ...
        this.setGridData = function (data) {
            ...
            if (typeof data.list !== 'undefined'){
                ...
                window[_this.sheetId].PageLength = data.list.length;
            }
        ...
        this.changePageHeight = function (obj, type) {
            ...
            if(parseInt(cnt) == 0){
            	...
            	if(type == "setGridPagingData"){
        			height = 66 + (30 * select_cnt);
            	}else{
            		height = 120 + (30 * select_cnt);
            	}
            }
            //스크롤바 없을 시 높이 감소
