			...
			function(obj){
				...
				try{
					...
					if ($U.isNull(calobj)){
						...
						document.body.insertAdjacentHTML("afterend", chtml);
						
					} else {
						$hD("tbody", calobj).innerHTML	=	hbody;
					...
					//--**	window event
					$U.eventbind(window, "onmousedown",	function(e){
